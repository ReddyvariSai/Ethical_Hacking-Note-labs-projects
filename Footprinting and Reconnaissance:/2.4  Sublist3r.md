...
Clone the official repository: git clone https://github.com/aboul3la/Sublist3r.git then cd Sublist3r.​
Install Python dependencies: sudo pip3 install -r requirements.txt or sudo apt install python3-requests python3-dnspython.​
Run with python3 sublist3r.py -d example.com
